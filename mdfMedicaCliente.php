...
<section class="advt-post bg-gray py-5">
  <div class="container">
    <form action="#!" method="POST">
            ...
            <?php
              $id_modificar=$_REQUEST["id"];
               ...
               include 'conexion.php';
                $query="SELECT pkIdAdulto, tipoSangreAdulto, alergiaAdulto, enfermedadAdulto FROM adultos where pkIdAdulto='$id_modificar'";
              ...
              echo  "<div class='col-lg-6'>
                    <h6 class='font-weight-bold pt-4 pb-1'>Tipo de sangre: </h6>
                    <input type='text' type='text' class='form-control bg-white' value='$sangre' id='sangre'>";
              
              echo  "<h6 class='font-weight-bold pt-4 pb-1'>Alergias: </h6>
                    <input type='text' type='text' class='form-control bg-white' value='$alergia' id='alergia'>
                    </div>";

              echo  "<div class='col-lg-6'>
                    <h6 class='font-weight-bold pt-4 pb-1'>Enfermedades: </h6>
                    <input type='text' type='text' class='form-control bg-white' value='$enfermedad' id='enfermedad'>";
      ...
      <button type="submit" class="btn btn-primary d-block mt-2" id="btn3">Guardar</button>
    </form>
  </div>
</section>
<!--============================
