...
$query="UPDATE contacto SET nombreContacto='$nombres', apellidoPatContacto='$apellidoPat', apellidoMatContacto='$apellidoMat', edadContacto='$edad', telFijoContacto='$telFijo', telMovilContacto='$telMovil', parentescoContacto='$parentesco' where pkIdContacto = '$id_modificar'";
      ...
      <div class="col-lg-6 col-md-6">
        <div class="package-content bg-light border text-center my-2 my-lg-0 p-5">
          <div class="package-content-heading border-bottom">
            ...
            echo "</div><br> <button type='button' class='btn btn-primary' id='btn4'>Aceptar</button> </div> </div>";
          }}
          ?>
