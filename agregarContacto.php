		...
		<div class="row">
			...
			<div class="col-lg-8">
				...
				<div class="widget welcome-message">
					<h2>Agregar nuevo contacto de emergencia				
					</h2>
				...
				<div class="row">
					<div class="col-lg-6 col-md-6">
						<div class="widget personal-info">
							...
							<form action="#">
								...
								<!-- Last Name -->
									<div class="form-group">
									<input type='text' class='form-control' placeholder="Apellido paterno" id='apellidoPat'>
									</div>

								<!-- Last Name -->
									<div class="form-group">
									<input type='text' class='form-control' placeholder="Apellido materno" id='apellidoMat'>
									</div>
					...
					<div class="widget change-password">
						<form action="#">	
							...
							<!-- Last Name -->
									<div class="form-group">
									<input type='text' class='form-control' placeholder="Telefono fijo" id='telFijo'>
									</div>

							<!-- New Password -->
							<!-- Last Name -->
									<div class="form-group">
									<input type='text' class='form-control' placeholder="Telefono movil" id='telMovil'>
									</div>
			...
			<div class="col-lg-4">
				<div class="sidebar">
					...
					<div class="widget user-dashboard-profile">
						...
						<!-- User Image -->
						<div class="profile-thumb"><h3 class="widget-header user">Agregar fotografia</h3>
            ...
            ?>     
					...
					<br><br><br>
					<button class="btn btn-transparent" id="btnAg">Agregar</button>

					<button class="btn btn-transparent" id="btnCancelar">Cancelar</button>
