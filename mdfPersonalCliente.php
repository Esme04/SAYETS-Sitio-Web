...
<section class="advt-post bg-gray py-5">
  <div class="container">
    <form action="#!" method="POST">
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <?php
              ...
              $query="SELECT pkIdAdulto, nombreAdulto, edadAdulto, telefonoAdulto FROM adultos where pkIdAdulto='$id_modificar'";
              ...
              echo  "<h6 class='font-weight-bold pt-4 pb-1'>Edad: </h6>
                    <input type='text' type='text' class='form-control bg-white' value='$edad' id='edad'>
                    ";


              echo  "
                    <h6 class='font-weight-bold pt-4 pb-1'>Telefono: </h6>
                    <input type='text' type='text' class='form-control bg-white' value='$telefono' id='telefono'>";
      ...
      <button type="submit" class="btn btn-primary d-block mt-2" style="position: absolute; left: 300px;" id="btn2">Guardar</button>
    </form>
  </div>
</section>
<!--============================
