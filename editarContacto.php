			...
			<div class="col-lg-8">
              ...
              echo "$nombres";
				...
				<div class="row">
                   ...
                   echo "<input type='text' class='form-control' value='$nombres' id='nombres'>";
           		    }
                 	} else {}
                	?>
                   ...
                   echo "<input type='text' class='form-control' value='$apellidoPat' id='apellidoPat'>";
           		    }
                 	} else {}
                	?>
                   ...
                   echo "<input type='text' class='form-control' value='$apellidoMat' id='apellidoMat'>";
           		    }
                 	} else {}
                	?>
                   ...
                   echo "<input type='text' class='form-control' value='$edad' id='edad'>";
           		    }
                 	} else {}
                	?>
					...
					<div class="widget change-password">
						<form action="#">	<h3 class="widget-header user"></h3>
							<!-- Current Password -->
							<div class="form-group">
                   ...
                   echo "<input type='text' class='form-control' value='$telFijo' id='telFijo'>";
           		    }
                 	} else {}
                	?>
                   ...
                   echo "<input type='text' class='form-control' value='$telMovil' id='telMovil'>";
           		    }
                 	} else {}
                	?>
                   ...
                   echo "<input type='text' class='form-control' value='$parentesco' id='parentesco'>";
                   echo "<div class='form-group'><input type='hidden' class='form-control input-lg' value='$id' id='id'></div>";
                	...
                	?>
							...
							<!-- Submit Button -->
							<button class="btn btn-transparent" id="btnGContacto">Guardar</button>
						</form>
					</div>
					</div>
