...
<!-- delete account popup modal end-->
			...
			<div class="col-lg-9">
				...
				<div class="widget dashboard-container my-adslist">
					<h3 class="widget-header">Información personal</h3>
					<table class="table table-bordered table-hover"  id="dataTable" width="100%" cellspacing="0">
						...
						<tbody>
								...
								<?php
								  $id_validar=$_REQUEST['id'];

                  include 'conexion.php';
                  $query="SELECT pkIdAdulto, nombreAdulto, edadAdulto, telefonoAdulto FROM adultos where pkIdAdulto='$id_validar' and estatusAdulto='1'";
                  $resultado = $mysqli->query($query);
                  if ($resultado->num_rows > 0) {
                  while($row = $resultado->fetch_assoc()) {
                  $id=$row["pkIdAdulto"];
                  $nombres=$row["nombreAdulto"];
                  $edad=$row["edadAdulto"];
                  $telefono=$row["telefonoAdulto"];

                  echo "<tr> ";
                  echo "<td class='product-thumb'>$nombres</td>";
                  echo "<td class='product-thumb'>$edad</td>";
                  echo "<td class='product-thumb'>$telefono</td>";
                  echo "<td class='text-center'><button type='button' class='btn btn-warning btn-circle btn-sm' id='p$id'><i class='fa fa-pencil'></i></button>";
                  echo "<br><br>";    
                  echo "<input value='$id' type='hidden' id='tp$id'>";
                  echo "<br></td></tr>";
                  }
                  } else {}
                  ?> 
			...
			<div class="widget dashboard-container my-adslist">
					<h3 class="widget-header">Información del domicilio</h3>
					<table class="table table-bordered table-hover"  id="dataTable" width="100%" cellspacing="0">
						<thead>
							<tr  style="color: #FFFFFF; background-color: #4A6FD6;">
								<th class="text-center">Estado</th>
								<th class="text-center">Municipio odelegación</th>
								<th class="text-center">Calle (nombre)</th>
								<th class="text-center"></th>
							</tr>
						</thead>
						<tbody>
                  ...
                  include 'conexion.php';
                  $query="SELECT pkIdAdulto, estadoAdulto, municipioAdulto, calleAdulto FROM adultos where pkIdAdulto='$id_validar' and estatusAdulto='1'";
                  $resultado = $mysqli->query($query);
                  if ($resultado->num_rows > 0) {
                  while($row = $resultado->fetch_assoc()) {
                  $id=$row["pkIdAdulto"];
                  ...
                  echo "<tr>";
                  echo "<td class='product-thumb'>$estado</td>";
                  echo "<td class='product-thumb'>$municipio</td>";
                  echo "<td class='product-thumb'>$calle</td>";
                  echo "<td class='text-center'><button type='button' class='btn btn-warning btn-circle btn-sm' id='d$id'><i class='fa fa-pencil'></i></button>";
                  echo "<br><br>";    
                  echo "<input value='$id' type='hidden' id='td$id'>";
                  echo "<br></td></tr>";
                  }
                  } else {}
                  ?> 
				...
				<div class="widget dashboard-container my-adslist">
					<h3 class="widget-header">Información medica</h3>
					<table class="table table-bordered table-hover"  id="dataTable" width="100%" cellspacing="0">
						<thead>
							<tr  style="color: #FFFFFF; background-color: #4A6FD6;">
                  ...
                  include 'conexion.php';
                  $query="SELECT pkIdAdulto, tipoSangreAdulto, alergiaAdulto, enfermedadAdulto FROM adultos where pkIdAdulto='$id_validar' and estatusAdulto='1'";
                  $resultado = $mysqli->query($query);
                  if ($resultado->num_rows > 0) {
                  while($row = $resultado->fetch_assoc()) {
                  $id=$row["pkIdAdulto"];
                  $sangre=$row["tipoSangreAdulto"];
                  $alergia=$row["alergiaAdulto"];
                  $enfermedad=$row["enfermedadAdulto"];

                  echo "<tr>";
                  echo "<td class='product-thumb'>$sangre</td>";
                  echo "<td class='product-thumb'>$alergia</td>";
                  echo "<td class='product-thumb'>$enfermedad</td>";
                  echo "<td class='text-center'><button type='button' class='btn btn-warning btn-circle btn-sm' id='m$id'><i class='fa fa-pencil'></i></button>";
                  echo "<br><br>";    
...
<script  type="text/javascript" src="js/conectaDomicilio.js"></script>
