...
$query="UPDATE adultos SET tipoSangreAdulto='$sangre', alergiaAdulto='$alergia', enfermedadAdulto='$enfermedad' where pkIdAdulto = '$id_modificar'";
        ...
        <div class="package-content bg-light border text-center my-2 my-lg-0 p-5">
          <div class="package-content-heading border-bottom">
           <img src="images/correcto.jpg" alt="" width="100">
            ...
            echo "</div><br> <button type='button' class='btn btn-primary' id='btnAceptar2'>Aceptar</button> </div> </div>";
          }}
          ?>
